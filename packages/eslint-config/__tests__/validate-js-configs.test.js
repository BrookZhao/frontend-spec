...
describe('Validate JS configs', () => {
  it('Validate @encodefe/eslint-config', async () => {
  ...
  it('Validate @encodefe/eslint-config/es5', async () => {
  ...
  it('Validate @encodefe/eslint-config/vue', async () => {
  ...
  it('Validate @encodefe/eslint-config/essential', async () => {
  ...
  it('Validate @encodefe/eslint-config/essential/es5', async () => {
  ...
  it('Validate @encodefe/eslint-config/essential/react', async () => {
  ...
  it('Validate @encodefe/eslint-config/essential/vue', async () => {
  ...
  it('Validate @encodefe/eslint-config/node', async () => {
