...
describe('Validate JS configs', () => {
  it('Validate fe-eslint-config', async () => {
  ...
  it('Validate fe-eslint-config/es5', async () => {
  ...
  it('Validate fe-eslint-config/vue', async () => {
  ...
  it('Validate fe-eslint-config/essential', async () => {
  ...
  it('Validate fe-eslint-config/essential/es5', async () => {
  ...
  it('Validate fe-eslint-config/essential/react', async () => {
  ...
  it('Validate fe-eslint-config/essential/vue', async () => {
  ...
  it('Validate fe-eslint-config/node', async () => {
