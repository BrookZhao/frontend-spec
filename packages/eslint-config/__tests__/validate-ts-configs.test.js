...
describe('Validate TS configs', () => {
  it('Validate fe-eslint-config/typescript', async () => {
  ...
  it('Validate fe-eslint-config/typescript/vue', async () => {
  ...
  it('Validate fe-eslint-config/essential/typescript', async () => {
  ...
  it('Validate fe-eslint-config/essential/typescript/react', async () => {
  ...
  it('Validate fe-eslint-config/essential/typescript/vue', async () => {
  ...
  it('Validate fe-eslint-config/typescript/node', async () => {
