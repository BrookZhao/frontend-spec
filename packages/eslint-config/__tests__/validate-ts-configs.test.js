...
describe('Validate TS configs', () => {
  it('Validate @encodefe/eslint-config/typescript', async () => {
  ...
  it('Validate @encodefe/eslint-config/typescript/vue', async () => {
  ...
  it('Validate @encodefe/eslint-config/essential/typescript', async () => {
  ...
  it('Validate @encodefe/eslint-config/essential/typescript/react', async () => {
  ...
  it('Validate @encodefe/eslint-config/essential/typescript/vue', async () => {
  ...
  it('Validate @encodefe/eslint-config/typescript/node', async () => {
